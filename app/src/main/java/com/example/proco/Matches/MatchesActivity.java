...
import com.example.proco.MainActivity;
...
public class MatchesActivity extends AppCompatActivity {
    ...
    DatabaseReference mCurUserIdInsideMatchConnection, mCheckLastSeen;
    ...
    public void getLastMessageInfo(DatabaseReference userOb){
        mCurUserIdInsideMatchConnection = userOb.child("connections").child("matches").child(currentUserId);
        mCurUserIdInsideMatchConnection.addValueEventListener(new ValueEventListener() {
            @Override
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists())  {
                    for (DataSnapshot match : dataSnapshot.getChildren()) {
                        FetchMatchInformation(match.getKey(), match.child("child").toString());
                    }
                }
            }
